    ...
    <>
      <div className="max-w-5xl mx-auto pt-20 space-y-6 pb-12 px-6">
        ...
        <div className="bg-red-500/5 rounded-xl p-6 border border-red-500/20">
          <h2 className="text-xl font-semibold mb-2 flex items-center gap-2 text-red-500">
            <svg
              className="w-5 h-5"
              fill="none"
              stroke="currentColor"
          ...
          <button
            ...
            className="px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium transition flex items-center gap-2"
          >
            <svg
              className="w-4 h-4"
              fill="none"
